...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.IbmWorkloadSchedulerApi.FileDeleteTriggerProperty = factory(root.IbmWorkloadSchedulerApi.ApiClient);
  }
  ...
  /**
   * The FileDeleteTriggerProperty model module.
   * @module com.ibm.tws.api/com.ibm.tws.model/FileDeleteTriggerProperty
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>FileDeleteTriggerProperty</code>.
   * @alias module:com.ibm.tws.api/com.ibm.tws.model/FileDeleteTriggerProperty
   * @class
   * @param filename
  ...
  /**
   * Constructs a <code>FileDeleteTriggerProperty</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.ibm.tws.api/com.ibm.tws.model/FileDeleteTriggerProperty} obj Optional instance to populate.
   * @return {module:com.ibm.tws.api/com.ibm.tws.model/FileDeleteTriggerProperty} The populated <code>FileDeleteTriggerProperty</code> instance.
   */
